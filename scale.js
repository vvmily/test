	...
	ImagesZoom.prototype = {
		...
		init: function(param){
			...
			var imgList   = document.querySelectorAll(params.elem + " img"),
				...
				zoomImg   = document.querySelector(".imgzoom_pack .img"),
				zoomClose = document.querySelector(".imgzoom_pack .imgzoom_x"),
				zoomBg = document.querySelector(".imgzoom_pack .imgzoom_bg"),
				imgSrc    = "";
			...
			/*zoomClose.addEventListener("click", closeMask, false);
			zoomBg.addEventListener("click", closeMask, false);
